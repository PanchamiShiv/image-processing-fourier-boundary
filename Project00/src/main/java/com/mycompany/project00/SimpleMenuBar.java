...
g.img_pro.img_out4=new BufferedImage(g.img_pro.img.getWidth(),g.img_pro.img.getHeight(),BufferedImage.TYPE_INT_ARGB);
    ...
    g.ic1_out=new ImageIcon(g.img_pro.img_out1);
    g.output1.setIcon(g.ic1_out);
              
    g.ic2_out=new ImageIcon(g.img_pro.img_out2);
    g.output2.setIcon(g.ic2_out);
    
    g.ic3_out=new ImageIcon(g.img_pro.img_out3);
    g.output3.setIcon(g.ic3_out);
    
    g.ic4_out=new ImageIcon(g.img_pro.img_out4);
    g.output4.setIcon(g.ic4_out);
